...
> Secrets necessários: `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY`, `EC2_HOST`, `EC2_SSH_KEY`

> Observação: o workflow copia os manifests para a EC2 antes de aplicar com `kubectl`.
